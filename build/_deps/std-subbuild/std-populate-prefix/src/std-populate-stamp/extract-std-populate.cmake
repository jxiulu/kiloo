...
#
get_filename_component(filename "/modules/c++/v1/" ABSOLUTE)
get_filename_component(directory "/Users/jerrylu/Documents/Projects/autotools/build/_deps/std-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-std-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-std-populate${i}")
